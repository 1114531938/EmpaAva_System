...
AVATAR_OUTPUT_ROOT = AVATAR_ROOT / "outputs"
...
def speaker_wiki_rows():
    wiki_path = AVATAR_ROOT / "EmotiVoice_runs" / "repo" / "data" / "youdao" / "text" / "README.md"
    rows = {}
...
def list_tts_speakers():
    speaker_path = AVATAR_ROOT / "EmotiVoice_runs" / "repo" / "data" / "youdao" / "text" / "speaker2"
...
def list_digital_humans():
    media_root = AVATAR_ROOT / "GSavatar_runs" / "GaussianAvatars" / "media"

...
export DEPB_ROOT="${DEPB_ROOT:-$ROOT/apps/booth}"
export WEB_SCRIPT="${WEB_SCRIPT:-$ROOT/scripts/run_3depb.sh}"
export WEB_LOG="${WEB_LOG:-$ROOT/runtime/outputs/service_logs/booth_web.log}"
export WEB_PID_FILE="${WEB_PID_FILE:-$ROOT/runtime/outputs/service_logs/booth_web.pid}"
